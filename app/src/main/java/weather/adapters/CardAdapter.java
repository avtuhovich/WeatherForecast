...
//RecyclerView - компонент интерфейса, позваляет нам создавать прокручиваемый список
...
public class CardAdapter extends RecyclerView.Adapter<CardAdapter.CardViewHolder> {
    ...
    // создание нового объекта CardViewHolder() каждый раз, когда RecyclerView в этом нуждается
    // создается новая строка списка
    @Override
    ...
    //заполнение необходимыми данными строки
    @Override
    public void onBindViewHolder(final CardViewHolder holder, final int listPosition) {
        ...
        // getTime возвращает кол-во миллисекунд, прошедших с полуночи 01.01.1970 до заданного времени (1с = 1000мс)
    ...
    private String getTime(Long milliTime) {
        ...
        SimpleDateFormat df = new SimpleDateFormat("E, dd.MM.yyyy - HH:mm");
